...
import static View.ViewVariables.isStarted;
import static View.ViewVariables.restarted;
...
public class GameScene {
   ...
   static ImageView win;
    ...
    public  void startGame() {
        ...
        ViewVariables.timerActive=true;
        lifelost=false;
        isStarted=false;
        ...
        if(ViewVariables.difficulty==0)
            root=easy.setScene();
        else if(ViewVariables.difficulty==1)
    ...
    public static void startMoving(long now) {
                ...
                if(restarted) {
                    if (ViewVariables.FROGGER_LIVES == 0 || ViewVariables.burrowCounter == 5) {

                        enableAddButton = true;
                        pauseButton.setDisable(true);
                        mediaPlayer.pause();
                        ViewVariables.timerActive = false;
                        try {
                        ...
                        if (ViewVariables.FROGGER_LIVES == 0)
