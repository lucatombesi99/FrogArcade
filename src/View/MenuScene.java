...
public class MenuScene {
    ...
    static Media bkMusic = new Media(new File(AUDIO_PATH + "Frogger Main Song Theme (loop).mp3").toURI().toString());
...
public void getMenuScene(){
    ...
    playButton.setOnAction(e->{
        ...
        if(difficultyChoiceBox.getValue().equals("EASY"))
            ViewVariables.difficulty=0;
        else if(difficultyChoiceBox.getValue().equals("MEDIUM"))
            ViewVariables.difficulty=1;
        else
            ViewVariables.difficulty=2;
